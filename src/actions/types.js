...
export const CHANNEL_CREATE_DM__INIT = 'CHANNEL_CREATE_DM__INIT';
export const CHANNEL_CREATE_DM__SUCCESS = 'CHANNEL_CREATE_DM__SUCCESS';
export const CHANNEL_CREATE_DM__ERROR = 'CHANNEL_CREATE_DM__ERROR';

export const CHANNEL_ADD_REMOTE_MESSAGE = "CHANNEL_ADD_REMOTE_MESSAGE";

export const MESSAGE_CREATE__INIT = "MESSAGE_CREATE__INIT";
export const MESSAGE_CREATE__SUCCESS = "MESSAGE_CREATE__SUCCESS";
export const MESSAGE_CREATE__ERROR = "MESSAGE_CREATE__ERROR";

export const UPLOAD_MESSAGE_PHOTO__INIT = "UPLOAD_MESSAGE_PHOTO__INIT";
export const UPLOAD_MESSAGE_PHOTO__SUCCESS = "UPLOAD_MESSAGE_PHOTO__SUCCESS";
export const UPLOAD_MESSAGE_PHOTO__ERROR = "UPLOAD_MESSAGE_PHOTO__ERROR";
...
export const PROFILE_LOAD__INIT = 'PROFILE_LOAD__INIT';
export const PROFILE_LOAD__SUCCESS = 'PROFILE_LOAD__SUCCESS';
export const PROFILE_LOAD__ERROR = 'PROFILE_LOAD__ERROR';
